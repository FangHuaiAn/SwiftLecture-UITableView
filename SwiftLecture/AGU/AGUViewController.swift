...
class AGUViewController: UIViewController {

    let fetures : [String] = ["Baby", "Profile", "Group", "Task", "Note", "Post"]
...
extension AGUViewController : UITableViewDelegate, UITableViewDataSource {
