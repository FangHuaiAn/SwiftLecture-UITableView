...
class NashViewController: UIViewController {

    let fetures : [String] = ["Profile", "Playlist", "Audio"]
...
extension NashViewController : UITableViewDelegate, UITableViewDataSource {
